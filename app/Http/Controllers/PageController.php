...
class PageController extends Controller
{
    ...
    public function getDetail(Request $request)
    {
        ...
        $newproduct = Product::where('new', 1)->take(4)->get(); 
        $bestSellers = Product::where('new', 1)->take(4)->get(); 
        return view('page.chitiet_sanpham', compact('sanpham', 'splienquan', 'comments','newproduct','bestSellers'));
    }
